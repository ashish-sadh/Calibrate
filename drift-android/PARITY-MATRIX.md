...
| Hub | requestsCard (`:685`) — **iOS side device-verified** (scout #26: 'N request waiting' capsule + FRIEND REQUESTS card + green ✓ / grey ✕; accept lands). The **Android** incoming-request render is still undriven — my graph only ever had an outbound request | unknown | #1197 |
