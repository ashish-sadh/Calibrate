...
| Tool-result cards | 12 of 13 (food/nutrition/weight/workout/nav/supplement/medication/sleep/glucose/biomarker/help) are still `#if DRIFT_IOS_APP` — text summary only on Android | missing | #1125 |
