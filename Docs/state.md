...
- **Tests:** ~201 iOS DriftTests (UI/HealthKit/OCR-bound only — bulk of suite migrated down) + ~933 DriftCoreTests (cross-platform pure-logic suite, 8 env-skipped); LLM eval ~160+ cases in DriftLLMEvalMacOS. (Counts re-measured at build 358.)
