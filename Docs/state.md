...
- **Tests:** 1,274 iOS DriftTests (UI/HealthKit/OCR-bound only — bulk of suite migrated down) + 2,753 DriftCoreTests in 148 suites (cross-platform pure-logic suite, 1 known issue); LLM eval ~160+ cases in DriftLLMEvalMacOS. (DriftCore count re-measured 2026-08-11; iOS count last re-measured 2026-07-31.)
