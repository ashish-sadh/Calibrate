...
## Numbers
- **Version:** 0.1.0, Build 382 (iOS) · 97 (Android Play internal)
- **Tests:** 1,432 iOS DriftTests (1,234 swift-testing + 198 XCTest; UI/HealthKit/OCR-bound only — bulk of suite migrated down) + 2,771 DriftCoreTests in 149 suites (cross-platform pure-logic suite, 1 known issue); LLM eval ~160+ cases in DriftLLMEvalMacOS. (Both counts re-measured 2026-08-17.)
