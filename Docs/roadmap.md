...
- **AI Chat depth — extractor reliability & cross-domain flow (P0, cycle 2605 sprint)** — DomainExtractor 50-query isolated gold set (#239), tool-call auto-retry on empty result for top 5 tools (#240), cross-domain pronoun resolution (#241), clarification calibration v2 to cut false positives (#242). Plus extractor-stress food gold set (+25 cases, #243), +15 intent-blend cases (#246), +15 ordinal/topic-switch multi-turn cases (#245). Goal: every pipeline stage has an isolated ≥90% gold set; tail failures halved via retry; pronouns cross domains; no new StaticOverrides.
