...
## Corpus Check
- 912 files · ~4,859,590 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16342 nodes · 55271 edges · 187 communities detected
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 20287 edges (avg confidence: 0.8)
...
Cohesion: 0.0
Nodes (3312): add64(), allBase85(), anyOfInStr(), apndFileControl(), apndIsAppendvfsDatabase(), apndIsOrdinaryDatabaseFile(), apndOpen(), apndReadMark() (+3304 more)

### Community 1 - "Community 1"
Cohesion: 0.0
Nodes (855): AIActionExecutor, AIActionExecutor, FoodMatch, WeightIntent, AIChainOfThought, Step, AIChainOfThoughtPlanBoundaryTests, AIChatViewModel (+847 more)

### Community 2 - "Community 2"
Cohesion: 0.0
Nodes (782): logFood, saveConversationState(), AIDataCache, AIProfileService, AIRuleEngine, aiRuleEngineCaloriesLeft_overTarget_showsOverMessage(), aiRuleEngineCaloriesLeft_withModerateFood_showsRemaining(), aiRuleEngineDailySummary_withFoodLogged_doesNotSayNothingLogged() (+774 more)

### Community 3 - "Community 3"
Cohesion: 0.0
Nodes (786): Verdict, no, unclear, yes, AIActionExecutor, FoodLogIntentBridge, WorkoutExercise, AIBackend (+778 more)

### Community 4 - "Community 4"
Cohesion: 0.0
Nodes (474): completionSheet(), AddProgressEntryView, CameraTarget, MeasurementGuideSheet, AddMode, custom, popular, AddSupplementView (+466 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (1062): addAggInfoColumn(), addAggInfoFunc(), addArgumentToVtab(), addModuleArgument(), addOp4IntSlow(), addToVTrans(), agginfoFree(), agginfoPersistExprCb() (+1054 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (362): saveAsTemplate(), friendlyMessageTranslatesOfflineError(), friendlyMessageTranslatesTimeout(), gemma4URLIsPinnedToRevision(), isValidGGUFAcceptsGGUFMagic(), isValidGGUFRejectsEmptyFile(), isValidGGUFRejectsNonGGUFFile(), nonRetryableErrorsAreNotRetried() (+354 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (442): AffirmationParser, AffirmationParserBoundaryTests, affirmationNo(), affirmationUnclear(), affirmationYes(), longCorrectiveSentenceIsUnclearNotCancel(), negativeBeatsAmbiguous(), AIBackendCoordinator (+434 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (341): ActiveWorkoutRestTimerTests, ActiveExercise, ActiveSet, addExercise(), addFromCommand(), askCoach(), cancelRestEndNotification(), celebrateSetDone() (+333 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (314): food, foodServiceSearchFoodEmpty(), foodServiceSearchFoodRealFood(), foodServiceSearchFoodSpellCorrection(), synonymSearchFindsFood(), AppDatabaseFoodCountTests, makeTestDB(), food (+306 more)
...
Cohesion: 0.02
Nodes (54): AIBackend, DeviceCapability, AIBackendCoordinator, AIBackendCoordinatorTests, StaleLocalBackendMock, AmbiguityEval, value, RawDoc (+46 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (258): CodingKeys, barcode, brand, caloriesPer100g, carbsGPer100g, createdAt, fatGPer100g, fiberGPer100g (+250 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (227): accessPayload(), accessPayloadChecked(), allocateBtreePage(), allocateSpace(), allocateTempSpace(), anotherValidCursor(), assertCellInfo(), assertParentIndex() (+219 more)
...
Cohesion: 0.02
Nodes (79): App, AppDatabase, DbKeyValueStore, DriftAndroidAppDelegate, DriftAndroidRootView, HealthConnectFacade, bridgeSmokeTest(), dayBounds() (+71 more)
...
Cohesion: 0.03
Nodes (33): loadShareFriends(), ChatView, ClientDetailView, Role, assistant, user, ShareTemplateSheet, SharingService (+25 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (51): BackgroundTaskHandle, BackgroundTaskHandle, BackupScheduler, BGTask, SendableTaskBox, BackupSchedulerTests, Boom, CapturingSubmitter (+43 more)
...
Cohesion: 0.07
Nodes (35): synonymExpansionBasic(), SpellCorrectService, SpellCorrectServiceBoundaryTests, expandSynonyms_aloo(), expandSynonyms_chana(), expandSynonyms_crispsToChips(), expandSynonyms_dahi(), expandSynonyms_fries() (+27 more)
...
Cohesion: 0.36
Nodes (2): AppDatabaseInitializationTests, TestDBError
...
- **Why does `date` connect `Community 2` to `Community 32`, `Community 1`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 15`, `Community 16`, `Community 19`, `Community 20`, `Community 24`, `Community 27`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `date` connect `Community 2` to `Community 32`, `Community 1`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 15`, `Community 16`, `Community 20`, `Community 24`, `Community 27`?**
...
- **Are the 318 inferred relationships involving `empty` (e.g. with `barcodeCacheSaveAndRetrieve()` and `barcodeCacheReturnsNilOnMiss()`) actually correct?**
  _`empty` has 318 INFERRED edges - model-reasoned connections that need verification._